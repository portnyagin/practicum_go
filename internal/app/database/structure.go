...
const urls = "create table if not exists  urls (id numeric primary key, correlation_id varchar, short_url varchar, original_url varchar);\n" +
...
const user_urls = "create table if not exists  user_urls (user_id varchar, url_id varchar);\n" +
